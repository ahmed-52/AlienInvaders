...
ALIEN_IMAGES   = ('alien1.png','alien2.png','alien3.png','AlienBoss.png')
...
ALIEN_SPEED_ADJUSTMENT_FACTOR = 0.97

BOSS_ALIEN_H_WALK = ALIEN_WIDTH // 2

BOSS_ALIEN_SPEED = 0.3

BOSS_ALIEN_V_WALK = ALIEN_WIDTH // 2
